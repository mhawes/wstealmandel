...
% full caption
\caption{
    On the left: A bar chart to display the average frequency of steal operations and the average 
    frequency of victimisations, per thread id, over twenty test runs.
    On the right: A bar chart to show the average percentage of the raster-plane computed
