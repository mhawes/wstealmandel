...
The key difference to the \textit{Randomized Work-Stealing Algorithm} (described in section \ref{sec:randscheme}) is that a worker
...
This implementation uses four threads, each maintaining its own work-deque. 

\subsubsection*{The Deque Implementation}
% general description
Three key operation can be made on a deque. These are de\_pop\_bottom, de\_push\_bottom, and de\_steal.
