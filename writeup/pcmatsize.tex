...
\begin{tikzpicture}[x=0.035\textwidth,y=1.3cm]
...
% full caption
\caption{
    Average performance increase, relative to the sequential version of the program, against resolution of the raster-plane. 
    The maximum iteration count is seventy for each sample.
}
