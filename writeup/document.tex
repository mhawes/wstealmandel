...
to attempt to steal work from. If this steal operation is successful it pushes the stolen piece of work 
...
of a steal operation. Further still, a non-blocking deque can be made efficient through use of a circular array \cite{circdeque}.
...
thread is the most suitable candidate for a work-stealing operation.
