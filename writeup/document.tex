...
\begin{figure}[h]
\centering
\includegraphics[scale=0.5]{wsthreadactivity}
% full caption
\caption{
...
%TODO Talk about the pros and cons of this design!!!!
...
\subsubsection*{Implementation of The Output Mechanism}

% TODO Describe this process somehow. Pseudo code?
There are three functions which handle output of the plane (one per implemented outmode),
each using a nested for-loop approach. 
