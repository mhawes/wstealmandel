...
Load-balancing of parallel computer programs is a key technique for improving 
performance. It also serves to displace some of the burden of fairly distributing work-load
...
of defining part of the problem domain.
...
of the approach are identified and discussed.

% ---------------------------------------------------------------------------------------------------------------------------------------------------------------
\newpage
\section*{Acknowledgements}

The author would like to acknowledge Colin Egan for his invaluable guidance throughout this project, 
and for his sound technical and academic advice. 
...
% ---------------------------------------------------------------------------------------------------------------------------------------------------------------
% ---------------------------------------------------------------------------------------------------------------------------------------------------------------
\chapter{The Development and Implementation}
...
\item C-Compiler: GCC Version 4.7.2 - Level 3 Optimisations
\end{itemize}
...
\[ RelativePerformanceIncrease_a = \frac{AverageExecutionTime_a}{AverageExecutionTime_{sequntial}}\]
...
\item 
    ...
    This observation shows that by adding work-stealing techniques to a parallel scheme, which employs no 
    load balancing, increases its performance by an average of \(1.66\) times.
...
\item
    ...
    load-balancing capabilities, when considering the maximum iterations setting. This point is also true for the 
...
\item 
    ...
    be seen to outweigh the cost of simply allowing the thread to continue computing the given region.
...
\item 
    ...
    This outweighs the three instances in which a single steal operation occurs within any \(0.1\) second time-frame.
...
\end{table}
    ...
    victimisation of a thief, compounded by an unsuitable pseudo random number generator, could be responsible for the 
    unfairly balanced work load. 
    Further investigation is required to determine a more evident cause.
...
to investigate the subject area. Here is an evaluation of each objective defined in the introduction section, as well as some other aspects 
of the project which are of notable merit.
...
\subsubsection*{Background Research}
    ...
    The studied areas provide the reader with a sufficient overview of the themes explored in the subsequent chapters. To further 
...
\subsubsection*{Analysis of the Implemented Algorithms}
    ...
    This area proved challenging because of a lack of experience in such an exercise. This made making concise
    and well founded observations much more difficult.
    The work could be improved by producing better refined and well thought out test data sets. 
...
\subsubsection*{Professional Presentation of Material}
    All material is presented in a highly professional manner. This can be attributed to 
    choosing the right tools for the job.
    
    In particular, the decision to produce this entire report using \LaTeX~has been pivotal
    to the clarity and good structure exhibited. It has also provided a useful new skill set, 
...
To further investigate the work-stealing approach, configurations left un-explored by this report could be implemented. 
...
\item \textbf{Different Multi-Thread Designs: }
    Other approaches to parallel algorithm design could be explored to seek a more intuitive design.
...
The investigation finds that by applying the Randomised Work-Stealing Algorithm a significant speed-up is made over a similarly structured design, which 
...
The project as a whole is reflected upon in great depth and a good number of avenues for future work are laid out. 
Over-all the author considers the project 
...
The main and most valuable contribution is the implementation and design of a Randomised Work-Stealing algorithm. This demonstrates 
